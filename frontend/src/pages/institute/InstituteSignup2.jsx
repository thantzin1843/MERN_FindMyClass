...
function InstituteSignup2() {
  const navigate = useNavigate()
  const { data, updateData } = useInstituteSignUpContext();
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/institute/signup`,{
        method:"post",
        headers:{
      ...
      <div className="w-full lg:w-3/4 mx-auto mb-5 mt-5">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='my-5'>
            ...
            <input type="text" value={position} disabled placeholder='Position' className="border border-gray-400 p-2 rounded-md w-full" required />
          </div>
...
export default InstituteSignup2;
